...
public class GameBoardTest extends TestCase
{
    ...
    public void testGameBoard(){
        ...
        GameBoard instance = new GameBoard(CFState.DeckType.BEGINNER);
        instance = new GameBoard(CFState.DeckType.NOSET);
        instance = new GameBoard(CFState.DeckType.SHUFFLE);
        instance = new GameBoard(CFState.DeckType.NOSHUFFLE);
    ...
    /**
     * Tests the getRemainingDeckNumber() method
     */
    public void testGetNumber()
    {
        GameBoard instance = new GameBoard(CFState.DeckType.NOSHUFFLE);
        assertEquals(instance.getRemainingDeckNumber(), 69);
    }
