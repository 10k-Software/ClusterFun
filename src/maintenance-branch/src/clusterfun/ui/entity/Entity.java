...
public abstract class Entity
{
    ...
    enum Location
    {
        ...
        // TIMER position
        TIMER("timer", new Vector3f(640, 4, 1), 27),
        ...
        FULLSCREEN_CHECK("fullscreen check", new Vector3f(528, 408, 0), 33),
        
        // BEGINNER MODE CHECK position
        BEGINNER_MODE_CHECK("beginner mode check", new Vector3f(528, 280, 0), 34),
        
        // TIMED MODE CHECK position
        TIMED_MODE_CHECK("timed mode check", new Vector3f(528, 344, 0), 35),
