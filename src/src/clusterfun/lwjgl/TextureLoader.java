...
public class TextureLoader {
    ...
    { 
        ...
        BufferedImage bufferedImage = ImageIO.read(new BufferedInputStream(new FileInputStream(url)));
         
    //new BufferedInputStream(getClass().getClassLoader().getResourceAsStream(ref))); 
